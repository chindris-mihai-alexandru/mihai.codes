    ...
    return (
      <div class="linkedin-widget">
        ...
        >
          ...
          <div class="w-16 h-16 rounded-full border-2 border-border group-hover:border-accent transition-colors overflow-hidden flex items-center justify-center bg-[#0A66C2] flex-shrink-0">
            {imageUrl ? (
              <img
                src={displayImage}
                alt={name}
          ...
          <div class="min-w-0">
            ...
            <div class="flex items-center justify-center sm:justify-start gap-1 mt-2 text-xs text-[#0A66C2] font-medium">
